...
contract Handler is Test {
    ...
    /// this is assigned in th modifier
    address internal currentActor;

    /// #### MODIFIERS ####
    /// @dev creates an actor and adds it to the array
    /// @dev everytime a function is exposed on the handler.
    ...
    function deposit(uint256 amount) external payable createActor {
    ...
    function _pay(address to, uint256 amount) internal {
        ...
        /// if we send non empty data, fallback() will be called instead of receive()
